...
def load_images():
    Board.board_image = pygame.image.load(os.path.join("images/PNG/", f"{board}.png"))
    Board.board_image = pygame.transform.smoothscale(Board.board_image, (Board.size_of_board, Board.size_of_board))

    Board.identifiers_image = pygame.image.load(os.path.join("images/PNG/", "identifiers.png"))
    Board.identifiers_image = pygame.transform.smoothscale(Board.identifiers_image, (Board.size_of_identifiers, Board.size_of_identifiers))

    for p in Board.white_pieces:
        #print(f"Loading: {p.color}_{p.type.lower()}.png")
        p.image = pygame.image.load(os.path.join("images/PNG/", f"{p.color}_{p.type.lower()}.png")) 
        p.image = pygame.transform.smoothscale(p.image, (p.size, p.size))
    for p in Board.black_pieces:
        #print(f"Loading: {p.color}_{p.type.lower()}.png")
        p.image = pygame.image.load(os.path.join("images/PNG/", f"{p.color}_{p.type.lower()}.png")) 
        p.image = pygame.transform.smoothscale(p.image, (p.size, p.size))
